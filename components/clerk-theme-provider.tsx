      ...
      appearance={{
        ...
        elements: {
          modalContent: dark
            ...
            : "!bg-white !text-ink",
          userProfileRootBox: dark
            ? "!bg-[#1d1d1f] !text-white"
            : "!bg-white !text-ink",
          userProfilePage: dark
            ? "!bg-[#1d1d1f] !text-white"
            : "!bg-white !text-ink",
          userProfileNavbar: dark
            ? "!border-white/15 !bg-[#1d1d1f]"
            : "!border-black/10 !bg-white",
          userProfileSection: dark
            ? "!border-white/15 !text-white"
            : "!border-black/10 !text-ink",
          userProfileSection__profile: dark
            ? "!border-white/15 !text-white"
            : "!border-black/10 !text-ink",
          userProfileSection__emailAddresses: dark
            ? "!border-white/15 !text-white"
            : "!border-black/10 !text-ink",
          userProfileSection__phoneNumbers: dark
            ? "!border-white/15 !text-white"
            : "!border-black/10 !text-ink",
          userProfileSection__connectedAccounts: dark
            ? "!border-white/15 !text-white"
            : "!border-black/10 !text-ink",
          footer: dark
